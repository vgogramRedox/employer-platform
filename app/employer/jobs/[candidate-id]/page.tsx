...
const CandidateInfo = ({ header, content }: CandidateInfoProps) => (
  <Paper shadow="xs" p={'sm'} bg={'primary.10'} className="min-h-32 lg:max-w-[90%] mt-14">
...
function page() {
  return (
    <Box className="lg:w-[90%] flex  max-lg:w-full mx-auto max-lg:text-lg max-lg:p-4 mb-5">
      <Box className=" w-[40%] ">
